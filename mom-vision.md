---
  title : "MoM vision"
  description : "Regenerative Software Development"
  transition : "convex"
  author : "lakruzz"
---
...
<span>Building GxP grade software products in close collaboration with end-users</span><!-- .element class="fragment" -->
<span>— while maintaining high throughput.</span><!-- .element class="fragment" -->
<span>Our client relations should be based on mutual trust"</span><!-- .element class="fragment" -->
...
- **Explore** 
<span class="fragment">Use a Lean Product Development approach – based on a runway budget – to develop and validate a product market fit</span>

- **Exploit**
<span class="fragment">When market fit is validated, formalize the product delivery</span>
...
- Hypercare
- Continuous improvement<br/>(feature focus)
...
timeline
    title .tech that
    2025 Q4 : Eat all Aral budget
            : Release `gh-tt` as an open source tool
            : Measure on Throughput and Stability
            : Be appointed as IDP by IM_, Raise a budget
    2026 Q1 : IDP MVP
            : FTE=10, Head count=16 
            : Speak at 1 conference
            : 1 UX training class
            : Publish 2 tech posts or white papers
    2026 Q2 : 3 billable (Burn rate) projects
            : Speak a 3 conferences
            : Ship 1 Open Source product
            : IDP full onboarded
    2026 Q3 : Speak a 3 conferences
            : Publish 2 tech posts or white papers
            : Confirm community recognition
    2026 Q4 : FTE=15, Head count=20
    2027+   : Software eats software
```